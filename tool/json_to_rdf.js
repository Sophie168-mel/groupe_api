...
function individu_rdf(json_individu) {
  ...
  osm_link =
    ...
    json_individu["latitude"] +
    "&lon=" +
    json_individu["longitude"] +
    "#map=19/" +
    json_individu["latitude"] +
    "/" +
    json_individu["longitude"] +
  ...
  res += "\t<igeo:Region>\n";
  res +=
    '\t\t<igeo:nom xml:lang="fr">' +
    json_individu["nom_region"] +
    "</igeo:nom>\n";
  res +=
    "\t\t<igeo:code_region>" +
    json_individu["code_region"] +
    "</igeo:code_region>\n";
  res += "\t\t<geo:subdivision>\n";
  res += "\t\t<igeo:Departement>\n";
  res +=
    '\t\t\t<igeo:nom xml:lang="fr">' +
    json_individu["nom_departement"] +
    "</igeo:nom>\n";
  res +=
    "\t\t\t<igeo:code_departement>" +
    json_individu["code_departement"] +
    "</igeo:code_departement>\n";
  res += "\t\t</igeo:Departement>\n";
  res += "\t\t</geo:subdivision>\n";
  res += "\t\t\t<geo:subdivision>\n";
  ...
  res +=
    '\t\t\t\t<igeo:nom xml:lang="fr">' +
    json_individu["nom_commune"] +
    "</igeo:nom>\n";
  res +=
    "\t\t\t\t<igeo:code_commune>" +
    json_individu["code_commune"] +
    "</igeo:code_commune>\n";
  res += "\t\t\t</igeo:Commune>\n";
  res += "\t\t\t</geo:subdivision>\n";
  res += "\t<igeo:Region>\n";
